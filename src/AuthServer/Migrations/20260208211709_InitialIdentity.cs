...
namespace AuthServer.Migrations
{
    ...
    public partial class InitialIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeletionRequests_ApprovedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmailOutboxMessages_Status_NextAttemptUtc",
                table: "EmailOutboxMessages",
                columns: new[] { "Status", "NextAttemptUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_EmailOutboxMessages_UserId_CreatedUtc",
                table: "EmailOutboxMessages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InactivityPolicies_UpdatedByUserId",
                table: "InactivityPolicies",
                column: "UpdatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_InactivityPolicies_UpdatedUtc",
                table: "InactivityPolicies",
                column: "UpdatedUtc");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LoginHistory_TimestampUtc",
                table: "LoginHistory",
                column: "TimestampUtc");

            migrationBuilder.CreateIndex(
                name: "IX_LoginHistory_UserId_TimestampUtc",
                table: "LoginHistory",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrivacyPolicies_UpdatedByUserId",
                table: "PrivacyPolicies",
                column: "UpdatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_PrivacyPolicies_UpdatedUtc",
                table: "PrivacyPolicies",
                column: "UpdatedUtc");
