          ...
          <nav className="flex flex-col gap-6 px-4 pb-6">
            <NavSection
              ...
              items={[
                ...
                { to: "/oidc/clients", label: "Clients" },
                { to: "/oidc/scopes", label: "Scopes" },
                { to: "/oidc/resources", label: "Resources" },
              ]}
            />
            <NavSection
              title="Konfigurace"
              items={[
                { to: "/config/permissions", label: "Permissions" },
                { to: "/config/roles", label: "Roles" },
                { to: "/config/api-resources", label: "API Endpoints" },
              ]}
            />
            <NavSection title="Uživatelé" items={[{ to: "/users", label: "Users" }]} />
            <NavSection title="Audit" items={[{ to: "/audit", label: "Audit log" }]} />
          </nav>
        </aside>
